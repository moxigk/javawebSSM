		...
		<div class="main">
			<div class="sidebar">
				...
				<ul class="sidemune">
					...
					<li data-id="user">个人贺卡管理</li>
					<li data-id="usermanager">用户管理</li>
					<li data-id="cardmanager">模板管理</li>
            ...
            function loadInner(sId) {
                ...
                switch(sId) {
                    ...
                    case "#12":
                        ...
                        break;
                    case "#usermanager":
                        pathn = "user_manager.jsp";
                        i = 2;
                        break;
                    case "#cardmanager":
                        pathn = "card_manager.jsp";
                        i = 3;
                        break;
                    default:
                        pathn = "user_center.jsp";
